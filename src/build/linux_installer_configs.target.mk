...
quiet_cmd__home_user_mod_spdy_src_build_install_gyp_linux_installer_configs_target_save_build_info = ACTION _home_user_mod_spdy_src_build_install_gyp_linux_installer_configs_target_save_build_info $@
cmd__home_user_mod_spdy_src_build_install_gyp_linux_installer_configs_target_save_build_info = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd build; mkdir -p $(builddir)/installer; python ../build/version.py -f ../install/common/BRANDING -f ../mod_spdy/common/VERSION -f "$(obj)/gen/build/LASTCHANGE" -o "$(builddir)/installer/version.txt"
...
$(builddir)/installer/version.txt: install/common/BRANDING mod_spdy/common/VERSION $(obj)/gen/build/LASTCHANGE FORCE_DO_CMD
	$(call do_cmd,_home_user_mod_spdy_src_build_install_gyp_linux_installer_configs_target_save_build_info)

all_deps += $(builddir)/installer/version.txt
action__home_user_mod_spdy_src_build_install_gyp_linux_installer_configs_target_save_build_info_outputs := $(builddir)/installer/version.txt
