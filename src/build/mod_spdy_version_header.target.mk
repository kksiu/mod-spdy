...
quiet_cmd__home_user_mod_spdy_src_build_build_util_gyp_mod_spdy_version_header_target_version_header = ACTION Generating version header file: "$(obj)/gen/mod_spdy/common/version.h" $@
cmd__home_user_mod_spdy_src_build_build_util_gyp_mod_spdy_version_header_target_version_header = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd build; mkdir -p $(obj)/gen/mod_spdy/common; python version.py -f ../mod_spdy/common/VERSION -f "$(obj)/gen/build/LASTCHANGE" ../mod_spdy/common/version.h.in "$(obj)/gen/mod_spdy/common/version.h"
...
$(obj)/gen/mod_spdy/common/version.h: mod_spdy/common/VERSION $(obj)/gen/build/LASTCHANGE mod_spdy/common/version.h.in FORCE_DO_CMD
	$(call do_cmd,_home_user_mod_spdy_src_build_build_util_gyp_mod_spdy_version_header_target_version_header)

all_deps += $(obj)/gen/mod_spdy/common/version.h
action__home_user_mod_spdy_src_build_build_util_gyp_mod_spdy_version_header_target_version_header_outputs := $(obj)/gen/mod_spdy/common/version.h


### Rules for final target.
# Build our special outputs first.
$(obj).target/build/mod_spdy_version_header.stamp: | $(action__home_user_mod_spdy_src_build_build_util_gyp_mod_spdy_version_header_target_version_header_outputs)

# Preserve order dependency of special output on deps.
$(action__home_user_mod_spdy_src_build_build_util_gyp_mod_spdy_version_header_target_version_header_outputs): | $(obj).target/build/lastchange.stamp
