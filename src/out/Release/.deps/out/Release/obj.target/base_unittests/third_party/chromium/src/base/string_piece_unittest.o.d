cmd_out/Release/obj.target/base_unittests/third_party/chromium/src/base/string_piece_unittest.o := g++ '-DUNIT_TEST' '-DGTEST_HAS_RTTI=0' '-D__STDC_FORMAT_MACROS' '-DNDEBUG' -Ithird_party/chromium/src -I. -Itesting/gmock/include -Itesting/gtest/include  -Werror -pthread -fno-exceptions -Wall -Wno-unused-parameter -Wno-missing-field-initializers -D_FILE_OFFSET_BITS=64 -fvisibility=hidden -pipe -std=gnu++0x -fPIC -fno-strict-aliasing -O2 -fno-ident -fdata-sections -ffunction-sections -fno-rtti -fno-threadsafe-statics -fvisibility-inlines-hidden -MMD -MF out/Release/.deps/out/Release/obj.target/base_unittests/third_party/chromium/src/base/string_piece_unittest.o.d.raw  -c -o out/Release/obj.target/base_unittests/third_party/chromium/src/base/string_piece_unittest.o third_party/chromium/src/base/string_piece_unittest.cc
out/Release/obj.target/base_unittests/third_party/chromium/src/base/string_piece_unittest.o: \
